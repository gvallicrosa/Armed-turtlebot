/* Auto-generated by genmsg_cpp for file /home/user/workspaces/ros/Armed-turtlebot/mc/msg/TurtlebotSensorState.msg */
#ifndef MC_MESSAGE_TURTLEBOTSENSORSTATE_H
#define MC_MESSAGE_TURTLEBOTSENSORSTATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TurtlebotSensorState_ {
  ...
  typedef boost::shared_ptr< ::mc::TurtlebotSensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mc::TurtlebotSensorState_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TurtlebotSensorState
typedef  ::mc::TurtlebotSensorState_<std::allocator<void> > TurtlebotSensorState;

typedef boost::shared_ptr< ::mc::TurtlebotSensorState> TurtlebotSensorStatePtr;
typedef boost::shared_ptr< ::mc::TurtlebotSensorState const> TurtlebotSensorStateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::mc::TurtlebotSensorState_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::mc::TurtlebotSensorState_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::mc::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::mc::TurtlebotSensorState_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::mc::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "d8f8ec7fa031fc9cc88e8319cd08a785";
  }

  static const char* value(const  ::mc::TurtlebotSensorState_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xd8f8ec7fa031fc9cULL;
  static const uint64_t static_value2 = 0xc88e8319cd08a785ULL;
};

template<class ContainerAllocator>
struct DataType< ::mc::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "mc/TurtlebotSensorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::mc::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::mc::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::mc::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::mc::TurtlebotSensorState_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::mc::TurtlebotSensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::mc::TurtlebotSensorState_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // MC_MESSAGE_TURTLEBOTSENSORSTATE_H
